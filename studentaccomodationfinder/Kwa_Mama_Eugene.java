 ...
 * @author user
 */
public class Kwa_Mama_Eugene extends javax.swing.JFrame {

    /**
     * Creates new form Kwa_Mama_Eugene
     */
    public Kwa_Mama_Eugene(String plotName) {
        initComponents();
    PlotName.setText("Kwa Mama Eugene");
    loadRoomData();
...
private void loadRoomData() {
    ...
    try (Connection conn = Database.connect();
         ...
         ResultSet rs = stmt.executeQuery("SELECT Room_Id, Price, Status FROM room WHERE plotName = 'Kwa Mama Eugene' AND locality = 'Around Nyawita'")) {
        ...
        if (!hasData) {
            JOptionPane.showMessageDialog(this, "There are no rooms in Kwa Mama Eugene");
        }
...
private void updateHouseStatus(String houseNumber, String newStatus) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kwa_Mama_Eugene.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
            new Kwa_Mama_Eugene("Default Plot Name").setVisible(true);
            }
        });
    }
