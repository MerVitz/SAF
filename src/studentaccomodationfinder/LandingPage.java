...
import studentaccomodationfinder.SessionManager;
import javax.swing.*;
/**
 *
 * @author user
...
public class LandingPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(search_data, javax.swing.GroupLayout.DEFAULT_SIZE, 32, Short.MAX_VALUE))
                .addGap(18, 18, 18)
        ...
        Plots_In_Market.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Carolina Herein", "ACK", "Spaace", "Food Court" }));
        ...
        header.getAccessibleContext().setAccessibleDescription("Header Panel");
    ...
    private void sign_inActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sign_inActionPerformed
        // TODO add your handling code here:
    // Create an instance of Login_Interface
    Login_Interface loginWindow = new Login_Interface();
    // Make the Login_Interface window visible
    loginWindow.setVisible(true);
    // Optionally, hide the current window (LandingPage)
    ...
    if (!SessionManager.isUserSignedIn) {
        JOptionPane.showMessageDialog(this, "Please sign in to view plot details.");
        return;
    }   
   ...
   // detailsFrameKMB.setVisible(true);
    ...
    private void search_dataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_search_dataActionPerformed
        // TODO add your handling code here:
    if (!SessionManager.isUserSignedIn) {
        JOptionPane.showMessageDialog(this, "Please sign in to access this feature.");
        return;
    }        
